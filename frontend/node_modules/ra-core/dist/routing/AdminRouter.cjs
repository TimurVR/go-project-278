...
var BasenameContextProvider_1 = require("./BasenameContextProvider.cjs");
var RouterProviderContext_1 = require("./RouterProviderContext.cjs");
/**
...
var AdminRouter = function (_a) {
    ...
    var _c = (0, RouterProviderContext_1.useRouterProvider)(), RouterWrapper = _c.RouterWrapper, useInRouterContext = _c.useInRouterContext;
    ...
    return (React.createElement(BasenameContextProvider_1.BasenameContextProvider, { basename: isInRouter ? basename : '' },
        React.createElement(RouterWrapper, { basename: basename }, children)));
};
