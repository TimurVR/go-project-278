...
var useListParams_1 = require("./useListParams.cjs");
var useSelectAll_1 = require("./useSelectAll.cjs");
var export_1 = require("../../export/index.cjs");
var queryReducer_1 = require("./queryReducer.cjs");
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        limit = maxResults !== null && maxResults !== void 0 ? maxResults : (total != null ? total : exports.DEFAULT_MAX_RESULTS);
                        return [4 /*yield*/, dataProvider.getList(resource, {
                                sort: currentSort,
                                filter: filter
                                    ? __assign(__assign({}, query.filterValues), filter) : query.filterValues,
