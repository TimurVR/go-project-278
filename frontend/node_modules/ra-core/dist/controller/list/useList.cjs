...
var fetch_1 = require("../../dataProvider/fetch.cjs");
...
var useList = function (props) {
    ...
    var applyFilterAndSort = (0, react_1.useCallback)(function (records) {
        var tempData = records;
        if (filterValues) {
            ...
            tempData = records
                ...
                return Object.entries(flattenFilterValues_1).every(function (_a) {
                    ...
                    var recordValue = (0, get_js_1.default)(record, filterName);
    ...
    (0, react_1.useEffect)(function () {
        if (isPending || !data)
            return;
        var filteredAndSorted = applyFilterAndSort(data);
        var filteredLength = filteredAndSorted.length;
        var paginatedData = filteredAndSorted.slice((page - 1) * perPage, page * perPage);
        setFinalItems({
            data: paginatedData,
    ...
    var getData = (0, react_1.useCallback)(function () {
        var args_1 = [];
        ...
        return __awaiter(void 0, __spreadArray([], args_1, true), void 0, function (_a) {
            ...
            var _b = _a === void 0 ? {} : _a, maxResults = _b.maxResults;
            return __generator(this, function (_c) {
                if (isPending || !data) {
                    return [2 /*return*/, []];
                }
                filteredAndSorted = applyFilterAndSort(data);
                if (maxResults != null) {
                    return [2 /*return*/, filteredAndSorted.slice(0, maxResults)];
                }
                return [2 /*return*/, filteredAndSorted];
            });
        });
...
var defaultFilter = {};
var defaultFilterCallback = function (record) { return Boolean(record); };
