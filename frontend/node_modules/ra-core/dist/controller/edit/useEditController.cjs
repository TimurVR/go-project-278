...
var saveContext_1 = require("../saveContext/index.cjs");
/**
...
var useEditController = function (props) {
    ...
    var routeId = (0, routing_1.useParams)().id;
    if (!routeId && !propsId) {
    ...
    var _g = (0, saveContext_1.useMutationMiddlewares)(), registerMutationMiddleware = _g.registerMutationMiddleware, getMutateWithMiddlewares = _g.getMutateWithMiddlewares, unregisterMutationMiddleware = _g.unregisterMutationMiddleware;
    var _h = (0, dataProvider_1.useGetOne)(resource, { id: id, meta: queryMeta }, __assign({ enabled: (!isPendingAuthenticated && !isPendingCanAccess) ||
    ...
    var _j = (0, dataProvider_1.useUpdate)(resource, recordCached, __assign(__assign({ onSuccess: function () {
            var args = [];
