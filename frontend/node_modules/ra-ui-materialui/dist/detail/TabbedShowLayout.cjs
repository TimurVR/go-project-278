...
var TabbedShowLayoutTabs_1 = require("./TabbedShowLayoutTabs.cjs");
...
var TabbedShowLayout = function (inProps) {
    ...
    var _c = (0, ra_core_1.useRouterProvider)(), Route = _c.Route, Routes = _c.Routes, Outlet = _c.Outlet;
    ...
    var _d = (0, react_1.useState)(0), tabValue = _d[0], setTabValue = _d[1];
        ...
        React.createElement(Root, __assign({ className: className }, sanitizeRestProps(rest)), syncWithLocation ? (React.createElement(Routes, null,
            React.createElement(Route, { path: "/*", element: React.createElement(React.Fragment, null,
                    ...
                    React.createElement("div", { className: exports.TabbedShowLayoutClasses.content },
                        React.createElement(Outlet, null))) }, react_1.Children.map(nonNullChildren, function (tab, index) {
                return (0, react_1.isValidElement)(tab) ? (React.createElement(Route, { path: (0, TabbedShowLayoutTabs_1.getShowLayoutTabFullPath)(tab, index), element: (0, react_1.cloneElement)(tab, {
                        context: 'content',
                        spacing: spacing,
                        divider: divider,
                    }) })) : null;
