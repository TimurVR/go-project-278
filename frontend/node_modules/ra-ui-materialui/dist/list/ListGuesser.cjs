...
exports.ListGuesserView = exports.ListGuesser = void 0;
var React = __importStar(require("react"));
var react_1 = require("react");
var ra_core_1 = require("ra-core");
var ListView_1 = require("./ListView.cjs");
var listFieldTypes_1 = require("./listFieldTypes.cjs");
...
var ListGuesser = function (props) {
    ...
    return (React.createElement(ra_core_1.ListBase, { debounce: debounce, disableAuthentication: disableAuthentication, disableSyncWithLocation: disableSyncWithLocation, exporter: exporter, filter: filter, filterDefaultValues: filterDefaultValues, perPage: perPage, queryOptions: {
        ...
        React.createElement(exports.ListGuesserView, __assign({}, rest))));
};
exports.ListGuesser = ListGuesser;
var ListGuesserView = function (props) {
    ...
    (0, react_1.useEffect)(function () {
        if (data && data.length > 0 && !child) {
            ...
            var components = ['List']
                ...
                .filter(function (component) { return !component.match(/[A-Za-z]+\.[A-Za-z]+/i); })
                .sort();
            if (enableLog) {
...
exports.ListGuesserView = ListGuesserView;
