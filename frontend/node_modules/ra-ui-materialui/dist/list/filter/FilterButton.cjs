...
var FilterButtonMenuItem_1 = require("./FilterButtonMenuItem.cjs");
var button_1 = require("../../button/index.cjs");
var AddSavedQueryDialog_1 = require("./AddSavedQueryDialog.cjs");
var RemoveSavedQueryDialog_1 = require("./RemoveSavedQueryDialog.cjs");
var FilterButton = function (inProps) {
    ...
    var filters = (0, ra_core_1.useFilterContext)() || filtersProp;
    ...
    var savedQueries = (0, ra_core_1.useSavedQueries)(resource || '')[0];
    ...
    var hasFilterValues = !(0, isEqual_js_1.default)(filterValues, {});
    var validSavedQueries = (0, ra_core_1.extractValidSavedQueries)(savedQueries);
    var hasSavedCurrentQuery = validSavedQueries.some(function (savedQuery) {
        return (0, isEqual_js_1.default)(savedQuery.value, {
            filter: filterValues,
            sort: sort,
            perPage: perPage,
