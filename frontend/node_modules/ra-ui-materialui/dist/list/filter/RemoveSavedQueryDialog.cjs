...
var RemoveSavedQueryDialog = function (_a) {
    ...
    var _c = (0, ra_core_1.useSavedQueries)(resource), savedQueries = _c[0], setSavedQueries = _c[1];
    var removeQuery = function () {
        ...
        var newSavedQueries = (0, ra_core_1.extractValidSavedQueries)(savedQueries);
        var index = newSavedQueries.findIndex(function (savedFilter) {
            return (0, isEqual_js_1.default)(savedFilter.value, savedQueryToRemove);
        });
