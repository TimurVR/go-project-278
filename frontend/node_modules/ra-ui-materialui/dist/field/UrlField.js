...
var UrlFieldImpl = function (inProps) {
    ...
    return (React.createElement(StyledLink, __assign({ className: className, href: value, onClick: stopPropagation, variant: "body2" }, sanitizeFieldRestProps(rest)), content !== null && content !== void 0 ? content : value));
};
