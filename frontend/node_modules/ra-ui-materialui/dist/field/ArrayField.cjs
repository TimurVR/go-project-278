...
var ArrayFieldImpl = function (props) {
    var children = props.children, resource = props.resource, perPage = props.perPage, sort = props.sort, filter = props.filter, exporter = props.exporter;
    var data = (0, ra_core_1.useFieldValue)(props) || emptyArray;
    var listContext = (0, ra_core_1.useList)({
        data: data,
        resource: resource,
        perPage: perPage,
        sort: sort,
...
exports.ArrayField = (0, ra_core_1.genericMemo)(ArrayFieldImpl);
var emptyArray = [];
