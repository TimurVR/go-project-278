...
export var TabbedFormView = function (inProps) {
    ...
    var _e = useRouterProvider(), Route = _e.Route, Routes = _e.Routes;
    var location = useLocation();
    var matchPath = useMatchPath();
    var resource = useResourceContext(props);
    var _f = useState(0), tabValue = _f[0], setTabValue = _f[1];
