...
import { usePreferenceInput, usePreference, useRecordContext, useTranslate, useLocation, } from 'ra-core';
...
export var PageTitleConfigurable = function (_a) {
    ...
    return (React.createElement(Configurable, { editor: React.createElement(PageTitleEditor, null), preferenceKey: preferenceKey || "".concat(pathname, ".title"), sx: {
...
var PageTitleConfigurableInner = function (_a) {
    ...
    return typeof titleFromPreferences === 'string' ? (React.createElement("span", __assign({ className: props.className }, props), translate(titleFromPreferences, __assign(__assign({}, record), { _: titleFromPreferences })))) : (React.createElement(React.Fragment, null,
        React.createElement(PageTitle, __assign({ title: title, defaultTitle: defaultTitle }, props))));
};
