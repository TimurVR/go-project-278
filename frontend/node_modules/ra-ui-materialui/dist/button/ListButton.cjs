 ...
 * );
 */
exports.ListButton = React.forwardRef(function ListButton(inProps, ref) {
    ...
    return (React.createElement(StyledButton, __assign({ component: ra_core_1.LinkBase, ref: ref, to: createPath({ type: 'list', resource: resource }), state: scrollStates[String(scrollToTop)], 
