...
exports.BulkDeleteWithUndoButton = React.forwardRef(function BulkDeleteWithUndoButton(inProps, ref) {
    ...
    var _c = (0, ra_core_1.useBulkDeleteController)(rest), handleDelete = _c.handleDelete, isPending = _c.isPending;
    ...
    return (React.createElement(StyledButton, __assign({ ref: ref, onClick: handleClick, label: label, disabled: isPending, color: "error" }, sanitizeRestProps(rest)), icon));
});
