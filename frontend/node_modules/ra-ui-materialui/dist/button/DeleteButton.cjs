...
var DeleteWithUndoButton_1 = require("./DeleteWithUndoButton.cjs");
var DeleteWithConfirmButton_1 = require("./DeleteWithConfirmButton.cjs");
/**
 ...
 * };
 */
exports.DeleteButton = React.forwardRef(function DeleteButton(inProps, ref) {
    ...
    var finalMutationMode = mutationMode
        ...
        : (saveContext === null || saveContext === void 0 ? void 0 : saveContext.mutationMode)
            ...
            : 'undoable';
    return finalMutationMode === 'undoable' ? (React.createElement(DeleteWithUndoButton_1.DeleteWithUndoButton, __assign({ ref: ref, record: record }, rest))) : (React.createElement(DeleteWithConfirmButton_1.DeleteWithConfirmButton
