 ...
 * );
 */
exports.SelectAllButton = react_1.default.forwardRef(function SelectAllButton(inProps, ref) {
    ...
    if (total === selectedIds.length ||
        ...
        !areAllDataSelected)
        return null;
    return (react_1.default.createElement(StyledButton, __assign({ ref: ref, label: label, onClick: handleClick, type: "button" }, rest)));
});
