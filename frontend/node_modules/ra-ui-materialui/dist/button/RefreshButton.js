...
export var RefreshButton = React.forwardRef(function RefreshButton(inProps, ref) {
    ...
    return (React.createElement(StyledButton, __assign({ ref: ref, label: label, onClick: handleClick }, rest), icon));
});
var defaultIcon = React.createElement(NavigationRefresh, null);
var PREFIX = 'RaRefreshButton';
