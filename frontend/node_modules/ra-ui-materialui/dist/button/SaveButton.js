...
import { useSaveContext, useTranslate, warning, setSubmissionErrors, useRecordFromLocation, useFormIsDirty, } from 'ra-core';
/**
 ...
 * }
 */
export var SaveButton = React.forwardRef(function SaveButton(inProps, ref) {
    var _this = this;
    ...
    var _g = useFormState(), isValidating = _g.isValidating, isSubmitting = _g.isSubmitting;
    // useFormState().isDirty might differ from useFormState().dirtyFields (https://github.com/react-hook-form/react-hook-form/issues/4740)
    var isDirty = useFormIsDirty();
    ...
    var handleSubmit = useCallback(function (values) { return __awaiter(_this, void 0, void 0, function () {
        var errors;
