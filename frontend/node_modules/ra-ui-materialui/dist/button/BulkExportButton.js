...
import { useBulkExport, useResourceContext, } from 'ra-core';
 ...
 * );
 */
export var BulkExportButton = React.forwardRef(function BulkExportButton(inProps, ref) {
    ...
    return (React.createElement(StyledButton, __assign({ ref: ref, onClick: handleClick, label: label }, sanitizeRestProps(rest)), icon));
});
