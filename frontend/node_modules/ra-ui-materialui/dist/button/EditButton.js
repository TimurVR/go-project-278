 ...
 * );
 */
export var EditButton = React.forwardRef(function EditButton(inProps, ref) {
    var props = useThemeProps({
        props: inProps,
        name: PREFIX,
    });
    var _a = props.icon, icon = _a === void 0 ? defaultIcon : _a, labelProp = props.label, _b = props.scrollToTop, scrollToTop = _b === void 0 ? true : _b, className = props.className, rest = __rest(props, ["icon", "label", "scrollToTop", "className"]);
    ...
    var label = useResourceTranslation({
        resourceI18nKey: "resources.".concat(resource, ".action.edit"),
    ...
    if (!record || !canAccess || isPending)
        return null;
    return (React.createElement(StyledButton, __assign({ component: LinkBase, ref: ref, to: createPath({ type: 'edit', resource: resource, id: record.id }), state: scrollStates[String(scrollToTop)], 
