...
exports.Button = React.forwardRef(function Button(inProps, ref) {
    ...
    return isXSmall ? (label && !disabled ? (React.createElement(material_1.Tooltip, { title: translatedLabel },
        React.createElement(material_1.IconButton, __assign({ ref: ref, "aria-label": typeof translatedLabel === 'string'
                ? translatedLabel
                : undefined, className: className, color: color, size: "large" }, linkParams, rest), children))) : (React.createElement(material_1.IconButton, __assign({ ref: ref, className: className, color: color, disabled: disabled, size: "large" }, linkParams, rest), children))) : (React.createElement(StyledButton, __assign({ ref: ref, className: className, color: color, size: size, "aria-label": typeof translatedLabel === 'string'
            ? translatedLabel
