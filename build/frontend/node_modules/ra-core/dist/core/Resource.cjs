...
var ResourceContextProvider_1 = require("./ResourceContextProvider.cjs");
...
var Resource = function (props) {
    ...
    return (React.createElement(ResourceContextProvider_1.ResourceContextProvider, { value: name },
        React.createElement(Routes, null,
            ...
            list && (React.createElement(Route, { path: "/*", element: React.createElement(routing_1.RestoreScrollPosition, { storeKey: "".concat(name, ".list.scrollPosition") }, getElement(list)) })),
            props.children)));
};
