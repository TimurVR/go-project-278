...
var useReferenceArrayFieldController_1 = require("./useReferenceArrayFieldController.cjs");
...
var ReferenceArrayFieldBase = function (props) {
    var children = props.children, render = props.render, error = props.error, loading = props.loading, empty = props.empty, filter = props.filter, exporter = props.exporter, offline = props.offline, _a = props.page, page = _a === void 0 ? 1 : _a, perPage = props.perPage, reference = props.reference, resource = props.resource, sort = props.sort, source = props.source, queryOptions = props.queryOptions;
    ...
    return (React.createElement(core_1.ResourceContextProvider, { value: reference },
        React.createElement(list_1.ListContextProvider, { value: controllerProps }, shouldRenderLoading
            ? loading
            : shouldRenderOffline
                ? offline
                : shouldRenderError
