...
var queryReducer_1 = __importStar(require("./queryReducer.cjs"));
var removeEmpty_1 = __importDefault(require("../../util/removeEmpty.cjs"));
var hooks_1 = require("../../util/hooks.cjs");
/**
...
var useListParams = function (_a) {
    ...
    var location = (0, routing_1.useLocation)();
    ...
    var debouncedSetFilters = (0, debounce_js_1.default)(function (filter, displayedFilters) {
        changeParams({
