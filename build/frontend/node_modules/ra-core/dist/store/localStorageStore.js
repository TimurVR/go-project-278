...
export var localStorageStore = function (version, appKey) {
    ...
    return {
        ...
        listItems: function (keyPrefix) {
            var storage = getStorage();
            var fullPrefix = "".concat(prefix, ".").concat(keyPrefix != null ? keyPrefix : '');
            return Object.entries(storage).reduce(function (acc, _a) {
                var key = _a[0], value = _a[1];
                if (
                // version is considered internal
                key !== "".concat(prefix, ".version") &&
