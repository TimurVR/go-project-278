...
var useAuthProvider_1 = __importStar(require("./useAuthProvider.cjs"));
var store_1 = require("../store/index.cjs");
var routing_1 = require("../routing/index.cjs");
var useCreatePath_1 = require("../routing/useCreatePath.cjs");
/**
...
var useLogout = function () {
    ...
    var logout = (0, react_1.useCallback)(function (params, redirectFromCaller, redirectToCurrentLocationAfterLogin) {
