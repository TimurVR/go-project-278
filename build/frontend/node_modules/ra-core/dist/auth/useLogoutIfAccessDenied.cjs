...
var useAuthProvider_1 = __importDefault(require("./useAuthProvider.cjs"));
var useLogout_1 = __importDefault(require("./useLogout.cjs"));
var notification_1 = require("../notification/index.cjs");
var useNavigate_1 = require("../routing/useNavigate.cjs");
var timer;
/**
...
var useLogoutIfAccessDenied = function () {
    ...
    var logoutIfAccessDenied = (0, react_1.useCallback)(function (errorFromCheckAuth) { return __awaiter(void 0, void 0, void 0, function () {
