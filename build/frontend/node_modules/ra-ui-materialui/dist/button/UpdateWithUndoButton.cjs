...
exports.UpdateWithUndoButton = React.forwardRef(function UpdateWithUndoButton(inProps, ref) {
    ...
    var _b = (0, ra_core_1.useUpdateController)(rest), handleUpdate = _b.handleUpdate, isPending = _b.isPending;
