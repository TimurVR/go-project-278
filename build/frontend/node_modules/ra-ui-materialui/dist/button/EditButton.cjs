 ...
 * );
 */
exports.EditButton = React.forwardRef(function EditButton(inProps, ref) {
    ...
    var _c = (0, ra_core_1.useCanAccess)({
        action: 'edit',
        resource: resource,
        record: record,
    }), canAccess = _c.canAccess, isPending = _c.isPending;
    var getResourceLabel = (0, ra_core_1.useGetResourceLabel)();
    var getRecordRepresentation = (0, ra_core_1.useGetRecordRepresentation)();
    ...
    if (!record || !canAccess || isPending)
        return null;
    return (React.createElement(StyledButton, __assign({ component: ra_core_1.LinkBase, ref: ref, to: createPath({ type: 'edit', resource: resource, id: record.id }), state: scrollStates[String(scrollToTop)], 
        // avoid double translation
        label: React.createElement(React.Fragment, null, label), "aria-label": typeof label === 'string' ? label : undefined, onClick: stopPropagation, className: (0, clsx_1.default)(exports.EditButtonClasses.root, className) }, rest), icon));
});
