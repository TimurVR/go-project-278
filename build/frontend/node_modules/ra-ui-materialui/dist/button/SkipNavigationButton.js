...
export var SkipNavigationButton = React.forwardRef(function SkipNavigationButton(inProps, ref) {
    var props = useThemeProps({
        props: inProps,
        name: PREFIX,
    });
    return (React.createElement(StyledButton, __assign({ ref: ref, onClick: skipToContent, className: 'skip-nav-button', label: "ra.navigation.skip_nav", variant: "contained" }, props)));
});
