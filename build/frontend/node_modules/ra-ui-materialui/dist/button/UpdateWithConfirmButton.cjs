...
exports.UpdateWithConfirmButton = React.forwardRef(function UpdateWithConfirmButton(inProps, ref) {
    ...
    var _f = (0, ra_core_1.useUpdateController)(__assign(__assign({}, rest), { mutationMode: mutationMode, mutationOptions: __assign(__assign({}, rest.mutationOptions), { onSettled: function () {
                var _a, _b;
                var args = [];
