...
export var ExportButton = React.forwardRef(function ExportButton(props, ref) {
    ...
    var _d = useListContext(), filter = _d.filter, filterValues = _d.filterValues, resource = _d.resource, sort = _d.sort, exporterFromContext = _d.exporter, total = _d.total, getData = _d.getData;
    ...
    return (React.createElement(Button, __assign({ ref: ref, onClick: handleClick, label: label, disabled: total === 0 }, sanitizeRestProps(rest)), icon));
});
