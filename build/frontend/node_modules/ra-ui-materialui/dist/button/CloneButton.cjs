...
exports.CloneButton = React.forwardRef(function CloneButton(inProps, ref) {
    ...
    return (React.createElement(StyledButton, __assign({ component: ra_core_1.LinkBase, ref: ref, to: record
            ? {
                pathname: pathname,
