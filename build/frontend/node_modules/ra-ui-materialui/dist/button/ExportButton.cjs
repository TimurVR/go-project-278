...
exports.ExportButton = React.forwardRef(function ExportButton(props, ref) {
    ...
    var _d = (0, ra_core_1.useListContext)(), filter = _d.filter, filterValues = _d.filterValues, resource = _d.resource, sort = _d.sort, exporterFromContext = _d.exporter, total = _d.total, getData = _d.getData;
    ...
    var handleClick = (0, react_1.useCallback)(function (event) {
        var fetchData = getData
            ? getData({ maxResults: maxResults, meta: meta })
            : dataProvider
                .getList(resource, {
                sort: sort,
                filter: filter
    ...
    return (React.createElement(Button_1.Button, __assign({ ref: ref, onClick: handleClick, label: label, disabled: total === 0 }, sanitizeRestProps(rest)), icon));
});
