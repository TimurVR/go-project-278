 ...
 * );
 */
export var SelectAllButton = React.forwardRef(function SelectAllButton(inProps, ref) {
    ...
    var _c = useListContext(), total = _c.total, selectedIds = _c.selectedIds, onSelectAll = _c.onSelectAll, data = _c.data;
    ...
    if (total === selectedIds.length ||
        ...
        !areAllDataSelected)
        return null;
    return (React.createElement(StyledButton, __assign({ ref: ref, label: label, onClick: handleClick, type: "button" }, rest)));
});
