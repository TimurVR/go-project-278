...
import { useResourceContext, useRecordContext, useTranslate, useGetRecordRepresentation, useResourceTranslation, useUpdateController, } from 'ra-core';
import { humanize, singularize } from 'inflection';
import { Button } from "./Button.js";
export var UpdateWithUndoButton = React.forwardRef(function UpdateWithUndoButton(inProps, ref) {
    ...
    var data = props.data, labelProp = props.label, _a = props.icon, icon = _a === void 0 ? defaultIcon : _a, onClick = props.onClick, rest = __rest(props, ["data", "label", "icon", "onClick"]);
    var _b = useUpdateController(rest), handleUpdate = _b.handleUpdate, isPending = _b.isPending;
    ...
    return (React.createElement(StyledButton, __assign({ ref: ref, onClick: handleClick, 
