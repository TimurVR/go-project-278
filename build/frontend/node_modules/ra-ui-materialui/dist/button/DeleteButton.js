...
import { useRecordContext, useSaveContext, useResourceContext, useCanAccess, } from 'ra-core';
import { useThemeProps } from '@mui/material/styles';
import { DeleteWithUndoButton, } from "./DeleteWithUndoButton.js";
import { DeleteWithConfirmButton, } from "./DeleteWithConfirmButton.js";
/**
 ...
 * };
 */
export var DeleteButton = React.forwardRef(function DeleteButton(inProps, ref) {
    ...
    var finalMutationMode = mutationMode
        ...
        : (saveContext === null || saveContext === void 0 ? void 0 : saveContext.mutationMode)
            ...
            : 'undoable';
    return finalMutationMode === 'undoable' ? (React.createElement(DeleteWithUndoButton, __assign({ ref: ref, record: record }, rest))) : (React.createElement(DeleteWithConfirmButton
    // @ts-ignore I looked for the error for one hour without finding it
    , __assign({ 
        // @ts-ignore I looked for the error for one hour without finding it
        mutationMode: finalMutationMode, ref: ref, record: record }, rest)));
});
var PREFIX = 'RaDeleteButton';
