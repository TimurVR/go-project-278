 ...
 * }
 */
exports.SaveButton = React.forwardRef(function SaveButton(inProps, ref) {
    var _this = this;
    ...
    var _g = (0, react_hook_form_1.useFormState)(), isValidating = _g.isValidating, isSubmitting = _g.isSubmitting;
    // useFormState().isDirty might differ from useFormState().dirtyFields (https://github.com/react-hook-form/react-hook-form/issues/4740)
    var isDirty = (0, ra_core_1.useFormIsDirty)();
    ...
    var recordFromLocation = (0, ra_core_1.useRecordFromLocation)();
    ...
    var handleSubmit = (0, react_1.useCallback)(function (values) { return __awaiter(_this, void 0, void 0, function () {
        var errors;
    ...
    var handleClick = (0, react_1.useCallback)(function (event) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (onClick) {
    ...
    return (React.createElement(StyledButton, __assign({ ref: ref, variant: variant, type: type, color: color, "aria-label": displayedLabel, disabled: disabled, onClick: handleClick }, rest),
