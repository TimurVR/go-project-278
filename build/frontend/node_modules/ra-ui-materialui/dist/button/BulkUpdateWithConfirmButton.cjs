...
exports.BulkUpdateWithConfirmButton = React.forwardRef(function BulkUpdateWithConfirmButton(inProps, ref) {
    ...
    var _g = (0, ra_core_1.useBulkUpdateController)(__assign(__assign({}, rest), { mutationMode: mutationMode, mutationOptions: __assign(__assign({}, rest.mutationOptions), { onSettled: function () {
                var _a, _b;
                var args = [];
    ...
    return (React.createElement(react_1.Fragment, null,
        React.createElement(StyledButton, __assign({ ref: ref, onClick: handleClick, label: label }, sanitizeRestProps(rest)), icon),
