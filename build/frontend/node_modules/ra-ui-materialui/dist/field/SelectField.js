...
import { useChoices, useFieldValue, useTranslate, genericMemo, } from 'ra-core';
...
var SelectFieldImpl = function (inProps) {
    ...
    return (React.createElement(StyledTypography, __assign({ component: "span", variant: "body2", className: className }, sanitizeFieldRestProps(rest)), choiceText));
};
