 ...
 */
var SelectFieldImpl = function (inProps) {
    ...
    return (React.createElement(StyledTypography, __assign({ component: "span", variant: "body2", className: className }, (0, sanitizeFieldRestProps_1.sanitizeFieldRestProps)(rest)), choiceText));
};
SelectFieldImpl.displayName = 'SelectFieldImpl';
exports.SelectField = (0, ra_core_1.genericMemo)(SelectFieldImpl);
var PREFIX = 'RaSelectField';
