...
var NumberFieldImpl = function (inProps) {
    ...
    return (React.createElement(StyledTypography, __assign({ variant: "body2", component: "span", className: className }, sanitizeFieldRestProps(rest)), hasNumberFormat && typeof value === 'number'
