...
var EmailFieldImpl = function (inProps) {
    ...
    return (React.createElement(StyledLink, __assign({ className: className, href: "mailto:".concat(value), onClick: stopPropagation, variant: "body2" }, (0, sanitizeFieldRestProps_1.sanitizeFieldRestProps)(rest)), value));
};
EmailFieldImpl.displayName = 'EmailFieldImpl';
exports.EmailField = (0, ra_core_1.genericMemo)(EmailFieldImpl);
