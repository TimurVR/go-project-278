...
export var useReferenceArrayFieldController = function (props) {
    var _a = props.filter, filter = _a === void 0 ? defaultFilter : _a, _b = props.exporter, exporter = _b === void 0 ? defaultExporter : _b, _c = props.page, page = _c === void 0 ? 1 : _c, _d = props.perPage, perPage = _d === void 0 ? 1000 : _d, record = props.record, reference = props.reference, sort = props.sort, source = props.source, _e = props.queryOptions, queryOptions = _e === void 0 ? {} : _e;
    ...
    var _f = useGetManyAggregate(reference, { ids: ids, meta: meta }, __assign({ onError: function (error) {
