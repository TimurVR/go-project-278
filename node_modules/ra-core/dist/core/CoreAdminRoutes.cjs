...
var useConfigureAdminRouterFromChildren_1 = require("./useConfigureAdminRouterFromChildren.cjs");
var HasDashboardContext_1 = require("./HasDashboardContext.cjs");
var NavigateToFirstResource_1 = require("./NavigateToFirstResource.cjs");
var CoreAdminRoutes = function (props) {
    (0, routing_1.useScrollToTop)();
    var _a = (0, routing_1.useRouterProvider)(), Route = _a.Route, Routes = _a.Routes;
    var _b = (0, useConfigureAdminRouterFromChildren_1.useConfigureAdminRouterFromChildren)(props.children), customRoutesWithLayout = _b.customRoutesWithLayout, customRoutesWithoutLayout = _b.customRoutesWithoutLayout, status = _b.status, resources = _b.resources;
    var Layout = props.layout, CatchAll = props.catchAll, dashboard = props.dashboard, LoadingPage = props.loading, requireAuth = props.requireAuth, Ready = props.ready, _c = props.authenticationError, AuthenticationError = _c === void 0 ? Noop : _c, _d = props.accessDenied, AccessDenied = _d === void 0 ? Noop : _d;
    var _e = (0, auth_1.useAuthState)(undefined, 
    // do not log the user out on failure to allow access to custom routes with no layout
    false, { enabled: requireAuth }), authenticated = _e.authenticated, isPendingAuthenticated = _e.isPending;
    if (status === 'empty') {
        if (!Ready) {
        ...
        React.createElement(Route, { path: "/*", element: React.createElement(HasDashboardContext_1.HasDashboardContextProvider, { value: !!dashboard },
                React.createElement(Layout, null,
                    React.createElement(Routes, null,
                        ...
                        react_1.Children.map(resources, function (resource) { return (React.createElement(Route, { key: resource.props.name, path: "".concat(resource.props.name, "/*"), element: resource })); }),
