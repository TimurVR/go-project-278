...
var DataTableRow = function (props) {
    ...
    var _a = useDataTableConfigContext().hasBulkActions, hasBulkActions = _a === void 0 ? false : _a;
    var _b = useDataTableCallbacksContext(), handleToggleItem = _b.handleToggleItem, rowClick = _b.rowClick;
    var selectedIds = useDataTableSelectedIdsContext();
    var handleClick = useEvent(function (event) { return __awaiter(void 0, void 0, void 0, function () {
...
export var DataTable = function (props) {
    var data = useListContext().data;
    return (React.createElement(DataTableBase, __assign({ hasBulkActions: false }, props, { empty: null, loading: null }),
        React.createElement("table", { border: 1, style: { width: '100%', borderCollapse: 'collapse' } },
            ...
            React.createElement(DataTableRenderContext.Provider, { value: "data" },
                React.createElement("tbody", null, data === null || data === void 0 ? void 0 : data.map(function (record) { return (React.createElement(RecordContextProvider, { key: record.id, value: record },
