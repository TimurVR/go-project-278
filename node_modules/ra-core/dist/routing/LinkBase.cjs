 ...
 * );
 */
exports.LinkBase = (0, react_1.forwardRef)(function (props, ref) {
    var provider = (0, RouterProviderContext_1.useRouterProvider)();
    return React.createElement(provider.Link, __assign({ ref: ref }, props));
});
