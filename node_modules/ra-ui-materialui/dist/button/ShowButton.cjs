...
var ShowButton = React.forwardRef(function ShowButton(inProps, ref) {
    ...
    if (!record || !canAccess || isPending)
        return null;
    return (React.createElement(StyledButton, __assign({ component: ra_core_1.LinkBase, ref: ref, to: createPath({ type: 'show', resource: resource, id: record.id }), state: scrollStates[String(scrollToTop)], 
