...
export var RefreshIconButton = React.forwardRef(function RefreshIconButton(props, ref) {
    ...
    return (React.createElement(Tooltip, { title: label && translate(label, { _: 'Refresh' }) },
        React.createElement(IconButton, __assign({ ref: ref, "aria-label": label && translate(label, { _: 'Refresh' }), className: className, color: "inherit", onClick: handleClick }, rest), icon)));
});
