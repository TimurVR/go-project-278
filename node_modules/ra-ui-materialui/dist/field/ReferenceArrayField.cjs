...
var SingleFieldList_1 = require("../list/SingleFieldList.cjs");
...
var ReferenceArrayField = function (inProps) {
    ...
    var pagination = props.pagination, children = props.children, className = props.className, sx = props.sx, render = props.render, _a = props.offline, offline = _a === void 0 ? defaultOffline : _a, controllerProps = __rest(props, ["pagination", "children", "className", "sx", "render", "offline"]);
    return (React.createElement(ra_core_1.ReferenceArrayFieldBase, __assign({}, controllerProps),
        React.createElement(PureReferenceArrayFieldView, { className: className, offline: offline, pagination: pagination, render: render, sx: sx }, children)));
};
...
var ReferenceArrayFieldView = function (props) {
    var children = props.children, render = props.render, offline = props.offline, pagination = props.pagination, className = props.className, sx = props.sx;
    var listContext = (0, ra_core_1.useListContext)();
    var isPaused = listContext.isPaused, isPending = listContext.isPending, isPlaceholderData = listContext.isPlaceholderData, total = listContext.total;
    var shouldRenderPending = isPending && !isPaused;
    var shouldRenderOffline = isPaused &&
        (isPending || isPlaceholderData) &&
        offline !== undefined &&
        offline !== false;
    return (React.createElement(Root, { className: className, sx: sx }, shouldRenderPending ? (React.createElement(layout_1.LinearProgress, { className: exports.ReferenceArrayFieldClasses.progress })) : shouldRenderOffline ? (offline) : (React.createElement("span", null,
...
var PureReferenceArrayFieldView = (0, ra_core_1.genericMemo)(exports.ReferenceArrayFieldView);
