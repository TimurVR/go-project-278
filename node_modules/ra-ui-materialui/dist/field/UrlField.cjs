...
var UrlFieldImpl = function (inProps) {
    ...
    return (React.createElement(StyledLink, __assign({ className: className, href: value, onClick: stopPropagation, variant: "body2" }, (0, sanitizeFieldRestProps_1.sanitizeFieldRestProps)(rest)), content !== null && content !== void 0 ? content : value));
};
UrlFieldImpl.displayName = 'UrlFieldImpl';
exports.UrlField = (0, ra_core_1.genericMemo)(UrlFieldImpl);
// useful to prevent click bubbling in a Datagrid with rowClick
var stopPropagation = function (e) { return e.stopPropagation(); };
var PREFIX = 'RaUrlField';
var StyledLink = (0, styles_1.styled)(material_1.Link, {
    name: PREFIX,
