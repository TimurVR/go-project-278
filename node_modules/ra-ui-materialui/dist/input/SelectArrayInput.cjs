...
var Labeled_1 = require("../Labeled.cjs");
/**
...
var SelectArrayInput = function (inProps) {
    ...
    var _k = (0, ra_core_1.useSupportCreateSuggestion)({
        create: create,
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledFormControl, __assign({ margin: margin, className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), error: fetchError || invalid, variant: variant }, sanitizeRestProps(rest)),
            React.createElement(material_1.InputLabel, __assign({ ref: inputLabel, id: "".concat(id, "-outlined-label"), htmlFor: id }, InputLabelProps),
