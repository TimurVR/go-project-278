...
var InputHelperText_1 = require("./InputHelperText.cjs");
var sanitizeInputRestProps_1 = require("./sanitizeInputRestProps.cjs");
...
var AutocompleteInput = function (inProps) {
    ...
    var _o = (0, ra_core_1.useChoicesContext)({
        choices: choicesProp,
    ...
    var _r = (0, ra_core_1.useSuggestions)({
        choices: finalChoices,
    ...
    var _s = (0, react_1.useState)(''), filterValue = _s[0], setFilterValue = _s[1];
    ...
    var debouncedSetFilter = (0, react_1.useCallback)((0, debounce_js_1.default)(function (filter) {
        if (setFilter) {
    ...
    var _t = (0, ra_core_1.useSupportCreateSuggestion)({
        create: create,
    ...
    var getOptionLabelString = (0, react_1.useCallback)(function (option, isListItem) {
        if (isListItem === void 0) { isListItem = false; }
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledAutocomplete, __assign({ className: (0, clsx_1.default)('ra-input', "ra-input-".concat(source), className), clearText: translate(clearText, { _: clearText }), closeText: translate(closeText, { _: closeText }), loadingText: isPaused && isPlaceholderData
                ...
                : noOptionsText, selectOnFocus: true, clearOnBlur: clearOnBlur }, (0, sanitizeInputRestProps_1.sanitizeInputRestProps)(rest), { freeSolo: !!create || !!onCreate, handleHomeEndKeys: !!create || !!onCreate, filterOptions: filterOptions, options: isPaused && isPlaceholderData
                ? []
...
var getSelectedItems = function (choices, value, optionValue, multiple) {
    ...
    if (multiple) {
        return (Array.isArray(value !== null && value !== void 0 ? value : []) ? value : [value])
            .map(function (item) {
            return choices.find(function (choice) { return String(item) === String((0, get_js_1.default)(choice, optionValue)); });
        })
            .filter(function (item) { return !!item; });
    }
    return (choices.find(function (choice) { return String((0, get_js_1.default)(choice, optionValue)) === String(value); }) || '');
};
    ...
    if (multiple) {
        ...
        var equalityArray = selectedChoiceArray.map(function (choice) {
            return newSelectedChoiceArray_1.some(function (newChoice) {
                return (0, get_js_1.default)(newChoice, optionValue) === (0, get_js_1.default)(choice, optionValue);
            });
        });
