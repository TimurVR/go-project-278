...
import { FieldTitle, useInput, useChoicesContext, useChoices, useGetRecordRepresentation, useSupportCreateSuggestion, } from 'ra-core';
...
export var SelectArrayInput = function (inProps) {
    ...
    var choicesProp = props.choices, className = props.className, create = props.create, createLabel = props.createLabel, createValue = props.createValue, _b = props.disableValue, disableValue = _b === void 0 ? 'disabled' : _b, format = props.format, helperText = props.helperText, label = props.label, InputLabelProps = props.InputLabelProps, isFetchingProp = props.isFetching, isLoadingProp = props.isLoading, isPendingProp = props.isPending, margin = props.margin, onBlur = props.onBlur, onChange = props.onChange, onCreate = props.onCreate, _c = props.options, options = _c === void 0 ? defaultOptions : _c, optionText = props.optionText, _d = props.optionValue, optionValue = _d === void 0 ? 'id' : _d, parse = props.parse, resourceProp = props.resource, _e = props.size, size = _e === void 0 ? 'small' : _e, sourceProp = props.source, translateChoice = props.translateChoice, validate = props.validate, variant = props.variant, disabled = props.disabled, readOnly = props.readOnly, rest = __rest(props, ["choices", "className", "create", "createLabel", "createValue", "disableValue", "format", "helperText", "label", "InputLabelProps", "isFetching", "isLoading", "isPending", "margin", "onBlur", "onChange", "onCreate", "options", "optionText", "optionValue", "parse", "resource", "size", "source", "translateChoice", "validate", "variant", "disabled", "readOnly"]);
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(StyledFormControl, __assign({ margin: margin, className: clsx('ra-input', "ra-input-".concat(source), className), error: fetchError || invalid, variant: variant }, sanitizeRestProps(rest)),
            React.createElement(InputLabel, __assign({ ref: inputLabel, id: "".concat(id, "-outlined-label"), htmlFor: id }, InputLabelProps),
