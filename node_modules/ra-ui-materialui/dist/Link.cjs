...
var Link = function (inProps) {
    ...
    return (React.createElement(StyledMuiLink, __assign({ component: ra_core_1.LinkBase, to: to, className: (0, clsx_1.default)(exports.LinkClasses.link, className) }, rest), children));
};
exports.Link = Link;
var PREFIX = 'RaLink';
exports.LinkClasses = {
