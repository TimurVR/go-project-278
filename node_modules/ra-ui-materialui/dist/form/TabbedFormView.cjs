...
var Toolbar_1 = require("./Toolbar.cjs");
var TabbedFormTabs_1 = require("./TabbedFormTabs.cjs");
var TabbedFormView = function (inProps) {
    ...
    var _e = (0, ra_core_1.useRouterProvider)(), Route = _e.Route, Routes = _e.Routes;
    var location = (0, ra_core_1.useLocation)();
    var matchPath = (0, ra_core_1.useMatchPath)();
    var resource = (0, ra_core_1.useResourceContext)(props);
    var _f = (0, react_1.useState)(0), tabValue = _f[0], setTabValue = _f[1];
